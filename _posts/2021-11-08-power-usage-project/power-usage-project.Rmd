...
description: |
  Through elhub.no I have access to all the power consumption data from my apartment. I have made the data available in an R package, and this is a brief look at it!
author:
  - name: Emma Skarstein
