...
Welcome to my power usage project! Through the fantastic service [elhub](https://www.elhub.no/) I have downloaded (and continue to download) monthly data sets that contain the hourly power usage in my appartment. I made an [R-package](https://github.com/emmaSkarstein/power.usage.analysis) that contains all the data plus some useful functions. Here I will explore some visualisations of the data.
